...
FigS1<-ggplot()+theme(panel.background = element_rect(fill='#FFFFFF'))+geom_point(data=dat2[dat2$Lat>-55 & dat2$Lat<55,], 
...
# Plot drifter data
FigS2<-ggplot()+theme(panel.background = element_rect(fill='#FFFFFF'))+geom_raster(data=dat2[dat2$Lat>-55 & dat2$Lat<55,], 
